    ...
    if (SearchName !== "") {
        $.post('https://qb-phone/FetchSearchResults', JSON.stringify({
            ...
            if (result != null) {
                ...
                QB.Phone.Notifications.Add("politie", "MDT", "Arama sonucu mevcut değil");
                $(".person-search-results").html("");
            }
        });
    } else {
        QB.Phone.Notifications.Add("politie", "MDT", "TBurada arama sonucu mevcut değil");
        $(".person-search-results").html("");
    }
});
...
$(document).on('click', '.scan-search-vehicle', function(e){
    ...
    $.post('https://qb-phone/FetchVehicleScan', JSON.stringify({}), function(vehicle){
        if (vehicle != null) {
            ...
            QB.Phone.Notifications.Add("politie", "MDT", "Yakınında araç yok!");
...
$(document).on('click', '.meos-recent-alert', function(e){
    ...
    if (alertData != undefined){
        if (alertData.coords != undefined && alertData.coords != null) {
            ...
            QB.Phone.Notifications.Add("politie", "MDT", "Uyarının GPS konumu yok");
        }
    }else {
        QB.Phone.Notifications.Add("politie", "MDT", "Aktif bir uyarı yok.");
    }
});
...
$(document).on('click', '.meos-clear-alerts', function(e){
    ...
    QB.Phone.Notifications.Add("politie", "MDT", "Tüm uyarılar silindi!");
});
