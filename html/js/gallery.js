...
$(document).on('click', '#tweet-button', function(e){
    ...
    if (TweetMessage != "") {
        ...
        QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Mesaj girmelisiniz!", "#00619c");
    };
    $('#tweet-new-url').val("");
...
$(document).on('click', '#advert-button', function(e){
    ...
    if (Advert !== "") {
        ...
        QB.Phone.Notifications.Add("fas fa-ad", "Sarı Sayfalar", "Boş bir ilan yayınlayamazsınız!", "#ff8f1a", 2000);
    }
});
