function LoadJobCenter(){
    $.post('https://qb-phone/GetJobCentersJobs', JSON.stringify({}), function(Jobs){
        ...
        for (const [k, v] of Object.entries(Jobs)) {
            var AddOption = '<div class="jobcenter-class-body-job" >'+'<div class="jobcenter-showitems-other"><i data-action="2" data-x="'+v.Coords[0]+'" data-y="'+v.Coords[1]+'" id="jobcenter-icon-class" class="fas fa-map-marked-alt"></i></div>'+v.label+'</div>'
