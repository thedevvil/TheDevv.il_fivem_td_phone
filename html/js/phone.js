                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        $.post('https://qb-phone/GetProfilePicture', JSON.stringify({
                            ...
                            $(".phone-call-outgoing-picture").css({"background-image":"url("+OpenedChatPicture+")"});
                        });
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Zaten görüşmedesiniz!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kişi meşgul!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kişi müsait değil!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kendinizi arayamazsınız!");
        }
    });
});
...
$(document).on('click', ".phone-keypad-key-call", function(e){
    ...
    $.post('https://qb-phone/CallContact', JSON.stringify({
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Zaten görüşmedesin!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kişi meşgul!");
                }
            ...
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Kendinizi arayamazsınız!");
        }
    });
});
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "Telefon", "Kendine mesaj gönderemezsin..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e){
    ...
    if (CurrentEditContactData.name == '') CurrentEditContactData.name = 'Hmm, Bunu yapamazsın...'
    CurrentEditContactData.number = ContactData.number

    $(".phone-edit-contact-header").text(ContactData.name+" Düzenle")
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName == '') ContactName = 'Hmm, Bunu yapamazsın...'
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Kişiyi Düzenle", "Tüm alanları doldurun!");
    }
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Kişi Ekle", "Tüm alanları doldurun!");
    }
});
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kişi görüşmede!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kişi meşgul!");
            }
...
IncomingCallAlert = function(CallData, Canceled, AnonymousCall) {
    if (!Canceled) {
        if (!QB.Phone.Data.CallActive) {
            ...
            QB.Phone.Animations.TopSlideUp('.'+QB.Phone.Data.currentApplication+"-app", 400, -160);
            setTimeout(function(){
                var Label = "Gelen bir aramanız var "+CallData.name
                if (AnonymousCall) {
                ...
                $.post('https://qb-phone/GetProfilePicture', JSON.stringify({
                            ...
                            $(".phone-call-incoming-picture").css({"background-image":"url("+OpenedChatPicture+")"});
                        });
                $(".phone-app").css({"display":"none"});
                QB.Phone.Functions.HeaderTextColor("white", 400);
...
QB.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        ...
        if (cData.CallType == "incoming") {
            ...
            $(".phone-currentcall-title").html("Görüşme ("+cData.CallTime+")");
        }
...
$(document).on('click', '.phone-currentcall-container', function(e){
    ...
    if (CallData.CallType == "incoming") {
        ...
        $.post('https://qb-phone/GetProfilePicture', JSON.stringify({
                            ...
                            $(".phone-call-ongoing-picture").css({"background-image":"url("+OpenedChatPicture+")"});
                        });
    }
...
QB.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
    ...
    if (AmountOfSuggestions > 0) {
        $(".amount-of-suggested-contacts").html(AmountOfSuggestions + " kişiler");
        ...
        $(".amount-of-suggested-contacts").html("0 kişiler");
    }
}
